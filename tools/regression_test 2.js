...
try{
 ...
 if(!/Avance remboursable.*TPE/i.test(rt[1]||'')) throw Error('reference roadmap rank 2 wrong: '+rt.join(' / '));
 if(!/Pacte création/i.test(rt[2]||'')) throw Error('reference roadmap rank 3 wrong: '+rt.join(' / '));
